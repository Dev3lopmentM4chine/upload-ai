...
const App = () => {
  return (
    <div className="flex flex-col h-screen">
      <div className="border-b flex flex-row justify-between px-6 py-3">
        ...
        <aside className="w-80 space-y-6">
          ...
          <form className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <span className="block text-sm text-muted-foreground itelic leading-relaxed">
